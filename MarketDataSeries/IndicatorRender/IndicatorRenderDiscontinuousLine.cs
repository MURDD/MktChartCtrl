...
{
    public class IndicatorRenderDiscontinuousLine : IndicatorRender
    {
        public IndicatorRenderDiscontinuousLine(string seriesName, IDataSeries dataSeries) : base(seriesName, dataSeries) { }
